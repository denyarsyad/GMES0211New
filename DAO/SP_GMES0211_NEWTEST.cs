...
{
    public class SP_GMES0211_NEWTEST : BaseProcClass
    {
        public SP_GMES0211_NEWTEST(string type = "Q")
        {
            // Modify Code : Procedure Name
            if (type == "Q")
            {
                _ProcName = "SP_GMES0211_Q_JJ_NEWTEST";
                //_ProcName = "SP_GMES0211_Q_JJ_TEST";
                ParamAdd();
            }
            else
                if (type == "S")
                {
                    _ProcName = "SP_GMES0211_S_JJ_V09_NEWTEST";
