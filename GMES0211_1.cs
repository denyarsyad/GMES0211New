...
namespace CSI.MES.P
{
    public partial class GMES0211_1 : CSIGMESBaseform6
    {
        public GMES0211_1()
        {
            InitializeComponent();
                        ...
                        if (param_type != "SUMMARY")
                        {
                            if (param_type != "GET_DATA")
                            {
                                ...
                                if (cboArea.EditValue.ToString() == "OSP")
                                {
                                    //if (param_type == "GET_SPART")
                                    //{
                                    //    //InitControls(grdReqSpart);
                                    //    //InitControls(gvwReqSpart);
                                    //    //gvwReqSpart.BeginUpdate();
                                    //    //gvwReqSpart.Columns.Clear();
                                    //    //grdReqSpart.DataSource = dtData;
                                    //    //gvwReqSpart.PopulateColumns(grdReqSpart.DataSource);
                                    //    //gvwReqSpart.EndUpdate();
                                    //    SetData(grdReqSpart, dtData);
        ...
        public void fn_Save(
            ...
            , string p_mc_line = "", string p_mc_no = "", string p_status = "", string p_division_type = "", string p_chk_ymd = "", string p_chk_hms = "", string p_chk_emp_id = "", string p_chk_emp_nm = "", string p_chk_msg = ""
            , string p_mc_id = "", string p_mc_type = "", string p_defec_cd = "", string p_repair_ymd = "", string p_repair_hms = ""
            , string p_repair_emp_id = "", string p_repair_emp_nm = "", string p_solu_cd = "", string p_mat_part = "", string p_cfm_empid = "", string p_cfm_emp_nm = ""
        )
        {
            ...
            dtData = cProc.SetParamDataSave(dtData
                ...
                , p_status, SessionInfo.UserID, p_cfm_empid, p_cfm_emp_nm, p_division_type
            );
        ...
        private void btnRequestSave_Click(object sender, EventArgs e)
        {
            ...
            if (lblEmpNameRequest.Text == "Not Found" || lblEmpNameRequest.Text == "" || lblEmpNameRequest.Text == " " || txtCondition.Text == "" || txtCondition.Text == " ")
            {
            ...
            try
            {
                fn_Save("SAVE", cboPlant.EditValue.ToString(), cboLocation.EditValue.ToString(), lblOPCD.Text, "", selectedDivision, lblReqYMD.Text, lblReqHMS.Text.ToString(), txtNikRequest.Text, lblEmpNameRequest.Text, txtCondition.Text, lblReqYMD.Text, lblWoSeq.Text, lblWoNo.Text, lblMCLine.Text, lblMCNo.Text, "R", rgMechanic.Properties.Items[rgMechanic.SelectedIndex].Value.ToString());
                pnlPopUp.Visible = false;
            //    if (cboArea.EditValue.ToString() == "OSP" && cboLocation.EditValue.ToString() == "51BT")
        ...
        private void btnCheckSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                fn_Save("SAVE", cboPlant.EditValue.ToString(), cboLocation.EditValue.ToString(), lblOPCD.Text, "", selectedDivision, lblReqYMD.Text, lblReqHMS.Text, txtNikRequest.Text, lblEmpNameRequest.Text, txtCondition.Text, lblReqYMD.Text, lblWoSeq.Text, lblWoNo.Text, lblMCLine.Text, lblMCNo.Text, "C", rgMechanic.Properties.Items[rgMechanic.SelectedIndex].Value.ToString(), lblChkYMD.Text, lblChkHMS.Text, cbNikCheck.Text, lblEmpNameCheck.Text, txtChkMsg.Text, /*cbMCID.Text*/ lookEMC_ID.EditValue.ToString(), "", lblDefectiveCD.Text);
                pnlPopUp.Visible = false;
                //if (cboArea.EditValue.ToString() == "OSP" && cboLocation.EditValue.ToString() == "51BT")
                //    fn_Search("GET_LAYOUT", cboPlant.EditValue.ToString(), cboLocation.EditValue.ToString(), "OSP");
                //else
        ...
        private void btnRepairSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                fn_Save("SAVE", cboPlant.EditValue.ToString(), cboLocation.EditValue.ToString(), lblOPCD.Text, "", selectedDivision, lblReqYMD.Text, lblReqHMS.Text, txtNikRequest.Text, lblEmpNameRequest.Text, txtCondition.Text, lblReqYMD.Text, lblWoSeq.Text, lblWoNo.Text, lblMCLine.Text, lblMCNo.Text, "C", rgMechanic.Properties.Items[rgMechanic.SelectedIndex].Value.ToString(), lblChkYMD.Text, lblChkHMS.Text, cbNikCheck.Text, lblEmpNameCheck.Text, txtChkMsg.Text, /*cbMCID.Text*/ lookEMC_ID.EditValue.ToString(), "", lblDefectiveCD.Text, lblRepairYMD.Text, lblRepairHMS.Text, emp_id, emp_name, lblSolutionCD.Text, part);
                pnlPopUp.Visible = false;
                //if (cboArea.EditValue.ToString() == "OSP" && cboLocation.EditValue.ToString() == "51BT")
                //    fn_Search("GET_LAYOUT", cboPlant.EditValue.ToString(), cboLocation.EditValue.ToString(), "OSP");
                //else
        ...
        {
            fn_Save("UPDATE_SOUND", cboPlant.EditValue.ToString(), cboLocation.EditValue.ToString(), selectedOP_CD, "", e.Argument.ToString(), "", "", "", "", "", "", "", lblWoNo.Text.ToString(), "", "", "N");
        ...
        private void MEPClick(object sender)
        {
            ...
            if (cboPlant.EditValue.ToString() == "3110" && (cboArea.EditValue.ToString() != "OSR" && cboLocation.EditValue.ToString() != "51SL") && (int.Parse(lbl.Name.Substring(chk, 1)) - 1) < dtAssyLine.Rows.Count)
        ...
        private void TL_QC_Click(object sender)
        {
            ...
            if (cboPlant.EditValue.ToString() == "3110" && cboArea.EditValue.ToString() != "OSR")
                mc_line = int.Parse(dtAssyLine.Rows[int.Parse(lbl.Name.Substring(chk, 1)) - 1]["CODE"].ToString()).ToString();
            else
                mc_line = lbl.Name.Substring(chk, 1);
            ...
            else
            {
                ...
                if (lbl.Name.ToUpper().IndexOf("PHM") >= 0 || lbl.Name.ToUpper().IndexOf("BUF") >= 0 ||
                    ...
                    lbl.Name.ToUpper().IndexOf("OSR") >= 0
                   )
                {
                    selectedDivision = "TL";
                }
        ...
        private void showPopUp_CallTLQC(string param_OP_CD, string param_mc_line, string param_mc_no, object sender)
        {
            ...
            if (sender != null)
            {
                ...
                if (cboPlant.EditValue.ToString() == "3110" && cboArea.EditValue.ToString() != "OSR" && cboLocation.EditValue.ToString() != "51SL")
                    mc_line = int.Parse(dtAssyLine.Rows[int.Parse(lbl.Name.Substring(chk, 1)) - 1]["CODE"].ToString()).ToString();
                else
                    mc_line = lbl.Name.Substring(chk, 1);
        ...
        private void setShowLayout()
        {
            ...
            if (cboArea.EditValue.ToString() == "OSP")
            {
                ...
                if (cboArea.EditValue.ToString() == "OSR")
                {
                    ...
                    if (cboArea.EditValue.ToString() == "FSS,FGA" &&
                            (cboLocation.EditValue.ToString() == "51B1" || cboLocation.EditValue.ToString() == "51C1"
                             || cboLocation.EditValue.ToString() == "51E1" //|| cboLocation.EditValue.ToString() == "51F1"
                             || cboLocation.EditValue.ToString() == "51A1" || cboLocation.EditValue.ToString() == "51A3"
                             || cboLocation.EditValue.ToString() == "51G1"
                       ...
                       )
                    {
                        ...
                        if (cboArea.EditValue.ToString() == "FSS,FGA" && 
                                (cboLocation.EditValue.ToString() == "51D1"
                           ...
                           )
                        {
                            ...
                            if (cboArea.EditValue.ToString() == "UPS" && (cboLocation.EditValue.ToString() == "51B1" || cboLocation.EditValue.ToString() == "51C1" || cboLocation.EditValue.ToString() == "51G1"))
                            {
                                ...
                                if (cboArea.EditValue.ToString() == "UPS" && cboLocation.EditValue.ToString() == "51D1")
                                {
                                    ...
                                    if (cboArea.EditValue.ToString() == "UPC,UPN" && (cboLocation.EditValue.ToString() == "51B1" || cboLocation.EditValue.ToString() == "51C1" || cboLocation.EditValue.ToString() == "51G1"))
                                    {
                                        ...
                                        if (cboArea.EditValue.ToString() == "UPC,UPN" && cboLocation.EditValue.ToString() == "51D1")
                                        {
                                            ...
                                            if (cboArea.EditValue.ToString() == "PHM,BUF,PHH,PHU")
                                            {
                                                ...
                                                if (cboArea.EditValue.ToString() == "UPC,UPN,UPS,FSS,FGA" && cboLocation.EditValue.ToString() == "51W1")
                                                {
                                                    ...
                                                    if (cboArea.EditValue.ToString() == "IPI,IPU" && cboLocation.EditValue.ToString() == "51IP")
                                                    {
                                                        ...
                                                        if (cboLocation.EditValue.ToString() == "51SL" && cboArea.EditValue.ToString() == "CIN,SKI,INC")
                                                        {
                                                            ...
                                                            if (cboLocation.EditValue.ToString() == "51SL" && cboArea.EditValue.ToString() == "UPE,UPF")
                                                            {
                                                                ...
                                                                if (cboLocation.EditValue.ToString() == "51SL" && cboArea.EditValue.ToString() == "UPH")
                                                                {
        ...
        private void setContentLayout(Control ctrl, DataTable dtTbl)
        {
            ...
            {
                if (/*x.Name == "lblIpi_1_MEP_zone1" || x.Name == "lblIpi_1_TL_zone1" || x.Name == "lblIpi_1_MEP_zone2" || x.Name == "lblIpi_1_TL_zone2" ||
                    x.Name == "lblIpi_1_MEP_zone3" || x.Name == "lblIpi_1_TL_zone3" || x.Name == "lblIpi_1_MEP_zone4" || x.Name == "lblIpi_1_TL_zone4" ||
                    x.Name == "lblIpi_1_MEP_zone5" || x.Name == "lblIpi_1_TL_zone5" || x.Name == "lblIpi_1_MEP_zone6" || x.Name == "lblIpi_1_TL_zone6" ||

                    x.Name == "lblIpi_2_MEP_zone7" || x.Name == "lblIpi_2_TL_zone7" || x.Name == "lblIpi_2_MEP_zone8" || x.Name == "lblIpi_2_TL_zone8" ||
                    x.Name == "lblIpi_2_MEP_zone9" || x.Name == "lblIpi_2_TL_zone9" || x.Name == "lblIpi_2_MEP_zone10" || x.Name == "lblIpi_2_TL_zone10" ||
                    x.Name == "lblIpi_2_MEP_zone11" || x.Name == "lblIpi_2_TL_zone11" || x.Name == "lblIpi_2_MEP_zone12" || x.Name == "lblIpi_2_TL_zone12" ||

                    x.Name == "lblIpi_3_MEP_zone13" || x.Name == "lblIpi_3_TL_zone13" || x.Name == "lblIpi_3_MEP_zone14" || x.Name == "lblIpi_3_TL_zone14" ||
                    x.Name == "lblIpi_3_MEP_zone15" || x.Name == "lblIpi_3_TL_zone15" || x.Name == "lblIpi_3_MEP_zone16" || x.Name == "lblIpi_3_TL_zone16" ||
                    x.Name == "lblIpi_3_MEP_zone17" || x.Name == "lblIpi_3_TL_zone17" || x.Name == "lblIpi_3_MEP_zone18" || x.Name == "lblIpi_3_TL_zone18" ||

                    x.Name == "lblIpi_4_MEP_zone19" || x.Name == "lblIpi_3_TL_zone19" || x.Name == "lblIpi_4_MEP_zone20" || x.Name == "lblIpi_3_TL_zone20" ||
                    x.Name == "lblIpi_4_MEP_zone21" || x.Name == "lblIpi_3_TL_zone21" || x.Name == "lblIpi_4_MEP_zone22" || x.Name == "lblIpi_3_TL_zone22" ||
                    x.Name == "lblIpi_4_MEP_zone23" || x.Name == "lblIpi_3_TL_zone23" ||

                    x.Name == "lblIpi_5_MEP_zone24" || x.Name == "lblIpi_3_TL_zone24" || x.Name == "lblIpi_5_MEP_zone25" || x.Name == "lblIpi_3_TL_zone25" ||
                    x.Name == "lblIpi_5_MEP_zone26" || x.Name == "lblIpi_3_TL_zone26" || x.Name == "lblIpi_5_MEP_zone27" || x.Name == "lblIpi_3_TL_zone27" ||
                    x.Name == "lblIpi_5_MEP_zone28" || x.Name == "lblIpi_3_TL_zone28" || x.Name == "lblIpi_5_MEP_zone29" || x.Name == "lblIpi_3_TL_zone29" ||

                    x.Name == "lblIpi_6_MEP_zone30" || x.Name == "lblIpi_3_TL_zone30" || x.Name == "lblIpi_6_MEP_zone31" || x.Name == "lblIpi_3_TL_zone31" ||
                    x.Name == "lblIpi_6_MEP_zone32" || x.Name == "lblIpi_3_TL_zone32" || x.Name == "lblIpi_6_MEP_zone33" || x.Name == "lblIpi_3_TL_zone33" ||
                    x.Name == "lblIpi_6_MEP_zone34" || x.Name == "lblIpi_3_TL_zone34" || x.Name == "lblIpi_6_MEP_zone35" || x.Name == "lblIpi_3_TL_zone35" ||

                    x.Name == "lblIpi_7_MEP_zone36" || x.Name == "lblIpi_3_TL_zone36" || x.Name == "lblIpi_7_MEP_zone37" || x.Name == "lblIpi_3_TL_zone37" ||
                    x.Name == "lblIpi_7_MEP_zone38" || x.Name == "lblIpi_3_TL_zone38" || x.Name == "lblIpi_7_MEP_zone39" || x.Name == "lblIpi_3_TL_zone39" ||
                    x.Name == "lblIpi_7_MEP_zone40" || x.Name == "lblIpi_3_TL_zone40" ||
                    
                    x.Name == "lblIpu_1_MEP_zone1" || x.Name == "lblIpu_1_MEP_zone2" || x.Name == "lblIpu_1_MEP_zone3" || x.Name == "lblIpu_1_MEP_zone4" ||
                    x.Name == "lblIpu_1_MEP_zone5" || x.Name == "lblIpu_1_MEP_zone6" || x.Name == "lblIpu_1_MEP_zone7" ||*/

                    //new layout
                    x.Name == "lblIpi_1_MEP_zone200" || x.Name == "lblIpi_1_TL_zone200" || x.Name == "lblIpi_1_MEP_zone201" || x.Name == "lblIpi_1_TL_zone201" ||
                    ...
                    )
                {
                    ...
                    if (
                        ...
                        || x.Name.ToUpper().Contains("UPE") || x.Name.ToUpper().Contains("UPF") || x.Name.ToUpper().Contains("UPH")
                        )
                    {
                        x.Text = "";
                        x.Parent.Text = "";
            ...
            foreach (Control c in allControls)
            {
                ...
                if (
                    ...
                    || c.Name.ToUpper().Contains("UPE") || c.Name.ToUpper().Contains("UPF") || c.Name.ToUpper().Contains("UPH")
                    )
                {
                ...
                if (dtTbl != null && dtTbl.Rows.Count > 0)
                {
                    ...
                    var dt = dtTbl.AsEnumerable().Where(row => row.Field<string>("OP_CD") == str
                        //&& row.Field<string>("MACHINE_LINE") == dtAssyLine.Rows[int.Parse(c.Name.Substring(chk, 1)) - 1]["CODE"].ToString() //plantC[int.Parse(c.Name.Substring(chk, 1)) - 1]
                                    && row.Field<string>("MACHINE_LINE") == ((cboPlant.EditValue.ToString() == "3110" && dtAssyLine != null && dtIdx < dtAssyLine.Rows.Count && cboArea.EditValue.ToString() != "OSR" && cboLocation.EditValue.ToString() != "51SL") ? int.Parse(dtAssyLine.Rows[dtIdx]["CODE"].ToString()).ToString() : c.Name.Substring(chk, 1)) //dtAssyLine.Rows[int.Parse(c.Name.Substring(chk, 1)) - 1]["CODE"].ToString()
                                    && row.Field<string>("MACHINE_SEQ") == seq
                                    && row.Field<string>("DIVISION") == div
                                );
        ...
        #region CUP INSOLE, SKIVING, INSOLE CUT
        ...
        private void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                fn_Save("CONFIRM", cboPlant.EditValue.ToString(), cboLocation.EditValue.ToString(), lblOPCD.Text, "", selectedDivision, lblReqYMD.Text, lblReqHMS.Text, txtNikRequest.Text, lblEmpNameRequest.Text, txtCondition.Text, lblReqYMD.Text, lblWoSeq.Text, lblWoNo.Text, lblMCLine.Text, lblMCNo.Text, "F", "", lblChkYMD.Text, lblChkHMS.Text, cbNikCheck.Text, lblEmpNameCheck.Text, txtChkMsg.Text, /*cbMCID.Text*/ lookEMC_ID.EditValue.ToString(), "", lblDefectiveCD.Text, lblRepairYMD.Text, lblRepairHMS.Text, "", "", lblSolutionCD.Text, "", txtNikConfirm.Text, lblEmpNameConfirm.Text);
                pnlPopUp.Visible = false;
                //if (cboArea.EditValue.ToString() == "OSP" && cboLocation.EditValue.ToString() == "51BT")
                //    fn_Search("GET_LAYOUT", cboPlant.EditValue.ToString(), cboLocation.EditValue.ToString(), "OSP");
                //else
        ...
        private void btnReqSpart_Click(object sender, EventArgs e)
        {
            ...
            try
            { 
                fn_Search("GET_SPART", cboPlant.EditValue.ToString(), lblWoNo.Text.ToString());
            }
            catch (Exception ex)
            {
        ...
        private void btnSaveReqSpart_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                fn_Save("SAVE_REQ_SPART", cboPlant.EditValue.ToString(), "", "", "", "", req_date, "", "", "", "", ro_date, "", lblWoNo.Text.ToString(), req_qty, in_qty, "", "", po_date, "", "", "", "", "", "", "", etd_date, in_date, "", "", "", part_cd);
                MessageBoxW("Success Saved !");
            }
            catch(Exception ex)
            {
